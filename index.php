...
<section class="bg-[#B4CA65] py-20 px-6 md:px-16">
  <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
    ...
    <!-- Image -->
    <div class="flex-1">
    <img src="https://cdn-icons-png.flaticon.com/512/2910/2910765.png" alt="Tâche" class="w-full max-w-sm mx-auto md:mx-0 rounded-lg shadow-lg">

      <!-- <img src="https://via.placeholder.com/400x300" alt="Task Illustration" class="w-full rounded-lg shadow-lg"> -->
    </div>
