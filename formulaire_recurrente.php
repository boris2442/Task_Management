...
<div class="min-h-screen bg-[#B4CA65] flex items-center justify-center p-6">
  <form action="ajouter_tache.php" method="POST" class="w-full max-w-xl bg-white p-8 rounded-2xl shadow-lg space-y-6">
    ...
    <h2 class="text-2xl font-bold text-red-400">Ajouter une tâche</h2>

    <!-- Titre -->
    <div>
      <label class="block text-[#333] mb-1 font-semibold">Titre de la tâche</label>
      <input type="text" name="titre" required class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-2 focus:border-[#B4CA65] focus:text-gray-800 text-gray-700" placeholder="Ex: Organiser un événement">
    </div>
    ...
    <div>
      ...
      <input type="date" name="date_fin" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-2 focus:border-[#B4CA65] focus:text-gray-800 text-gray-700">
    </div>
